...
var UnknownKey = /* @__PURE__ */ Symbol("Unknown Key");
var UnknownNonAccessorKey = /* @__PURE__ */ Symbol("Unknown Non-Accessor Key");
var UnknownInteger = /* @__PURE__ */ Symbol("Unknown Integer");
var UnknownWellKnown = /* @__PURE__ */ Symbol("Unknown Well-Known");
var SymbolToStringTag = /* @__PURE__ */ Symbol("Symbol.toStringTag");
var SymbolDispose = /* @__PURE__ */ Symbol("Symbol.asyncDispose");
var SymbolAsyncDispose = /* @__PURE__ */ Symbol("Symbol.dispose");
var SymbolHasInstance = /* @__PURE__ */ Symbol("Symbol.hasInstance");
...
var EntitiesKey = /* @__PURE__ */ Symbol("Entities");
...
var UnknownValue = /* @__PURE__ */ Symbol("Unknown Value");
var UnknownTruthyValue = /* @__PURE__ */ Symbol("Unknown Truthy Value");
var UnknownFalsyValue = /* @__PURE__ */ Symbol("Unknown Falsy Value");
...
var PureFunctionKey = /* @__PURE__ */ Symbol("PureFunction");
...
var IS_SKIPPED_CHAIN = /* @__PURE__ */ Symbol("IS_SKIPPED_CHAIN");
...
var ValueProperties = /* @__PURE__ */ Symbol("Value Properties");
  ...
  deoptimizeArgumentsOnInteractionAtPath(interaction, path, recursionTracker) {
    if (path.length > 1 || path.length === 1 && interaction.type === INTERACTION_CALLED) {
      ...
      if (typeof key === "string") {
        this.module.getExportedVariablesByName().get(key)?.deoptimizeArgumentsOnInteractionAtPath(interaction, path.slice(1), recursionTracker);
      } else {
        deoptimizeInteraction(interaction);
      }
    }
...
var UNASSIGNED$1 = /* @__PURE__ */ Symbol("Unassigned");
...
var UNASSIGNED = /* @__PURE__ */ Symbol("Unassigned");
...
var Module = class _Module {
  ...
  getRenderedExports() {
    ...
    for (const exportName of this.exportDescriptions.keys()) {
      (this.getExportedVariablesByName().get(exportName)?.included ? renderedExports : removedExports).push(exportName);
    }
...
var lowercaseBundleKeys = /* @__PURE__ */ Symbol("bundleKeys");
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-ACTK5EKC.js");
...
//# sourceMappingURL=chunk-DWYMI2XE.js.map
